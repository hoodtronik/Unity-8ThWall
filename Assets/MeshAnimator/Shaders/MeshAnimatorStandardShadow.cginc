...
// shadow pass — Unity 6 compatible
// In Unity 6 (6000.x), vertShadowCaster returns a struct via output parameter
// instead of separate float4 + struct params.
void MAVertShadowCaster (MAShadowVertexInput v
