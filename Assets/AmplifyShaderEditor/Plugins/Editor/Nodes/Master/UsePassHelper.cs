...
namespace AmplifyShaderEditor
{
	...
	public class UsePassHelper : ScriptableObject
	{
		...
		private void DisplayShaderContext( UndoParentNode node, Rect r )
		{
			...
			// Unity 6+: SetupShaderMenu was removed. The popup menu is auto-populated.
			// Original: UnityEditorInternal.InternalEditorUtility.SetupShaderMenu( m_dummyMaterial );
